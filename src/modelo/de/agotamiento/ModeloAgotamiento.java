...
public class ModeloAgotamiento extends javax.swing.JFrame {
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        d = Double.valueOf(jTextField2.getText());
        p = Double.valueOf(jTextField1.getText());
        c = Double.valueOf(jTextField3.getText());
        i = Double.valueOf(jTextField5.getText()) / 100;
        
        if((jTextField3.getText() != null) && (jTextField5.getText() != null)){
            h = c * i;
        }else{
            h = Double.valueOf(jTextField6.getText());
        }
        q = Math.sqrt((2 * s * (d*h) * (p + h)) / (p * h));
        w = q * (h / (p + h));
        
        sm = q-w;
        
        ct = (s * ((d*h)/sm)) + ((sm*sm)/(2*q))*h + ((w*w)/(2*q))*p;
        jLabel8.setText(String.valueOf(df.format(ct)));
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        q = Math.sqrt((2 * s * (d*h) * (p + h)) / (p * h));
        //Set text
        jLabel9.setText(String.valueOf(df.format(q)));
    ...
    private void jButton4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton4MouseClicked
        ...
        w = q * (h / (p + h));
        //Set text
        jLabel11.setText(String.valueOf(df.format(w)));
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        ...
        sm = q-w;
        //Set text
        jLabel10.setText(String.valueOf(df.format(sm)));
